...
- PR #114でCodex P1指摘を受領し、画面要件本文・Source of Truthを修正中。
...
1. 最新headでCodex再レビューを受ける。
2. 未解決review threadが0件であることを確認する。
3. 人間・法務・運用・安全・プライバシー・アクセシビリティレビューを受ける。
4. 問題がなければPR #114をマージする。
5. 後続で原本・変換後・履歴・監査メタデータの保持・削除要件を定義する。
6. 自宅周辺ぼかしアルゴリズム・距離閾値を別Issueで具体化する。
